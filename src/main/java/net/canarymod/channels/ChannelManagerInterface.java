...
public interface ChannelManagerInterface {
     ...
     * @param channel the name of the channel to register the client to.
     * @param handler the NetServerHandler for the client registering this channel.
     */
     ...
     * @param bytestream the message to be sent.
     ...
     * @param channel the channel the Custom Payload was sent on.
     * @param bytestream the message being sent.
     * @param player the player who sent the Custom Payload.
     */
     ...
     * @param channel the channel to send messages on.
     * @param bytestream the message to be sent.
     * @param player the player to send the Custom Payload to.
     * @return true if any packets were sent, false otherwise.
     */
     ...
     * @param channel The channel the client is listening on.
     * @param handler The NetServerHandler for the client.
     ...
     * @param handler The NetServerHandler for this client.
     ...
     * @param plugin The plugin to remove all lisiteners for.
