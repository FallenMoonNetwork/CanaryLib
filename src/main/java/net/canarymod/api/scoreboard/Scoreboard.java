...
public interface Scoreboard {
     ...
     * @param name Name of Objective to add.
     */
    public void addScoreObjective(String name);

    /**
     * Creates and Adds a scoreboard objective.
     * @param name The protocol name of the objective to add.
     * @param criteria The custom ScoreObjective Criteria<br>
    ...
    /**
     * Removes a ScoreObjective from this Scoreboard.
     * @param name The name of the Objective to remove.
     */
     ...
     * @param name The protocol name of the objective to get.
     ...
     * @param player name oft he player to get a score for.
     * @param scoreObjective the objective to get a score for.
     * @return {@link Score}
     */
    ...
    /**
     * Gets the score for the given player and given score objective.
     * @param name name of the score to get
     * @param scoreObjective the objective to get a score for.
     * @return {@link Score}
     */
     ...
     * @param scoreObjective score objective to get scores for.
     * @return
     */
