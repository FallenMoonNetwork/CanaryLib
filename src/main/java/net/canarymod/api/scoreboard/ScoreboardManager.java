...
public interface ScoreboardManager {
     ...
     * @param worldName Name of the world to get the scoreboard for.
    ...
    /**
     * Get the Scoreboard for this world.
     * @param world The world to get the scoreboard for.
     * @return the Scoreboard.
     */
     ...
     * @param name the protocol name of the criteria to get.
     ...
     * @param name the protocol name of the criteria to register.
     * @param criteria the class to register.
     */
