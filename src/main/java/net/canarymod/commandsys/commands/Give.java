...
public class Give extends CanaryCommand {

    public Give() {
        super("canary.command.give", Translator.translate("give info"), Translator.translateAndFormat("usage", "/give <item>:[data] [amount] [player]"), 2, 4);
    }
