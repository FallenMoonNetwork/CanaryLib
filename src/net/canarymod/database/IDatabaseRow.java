 ...
 * 
 * A row is part of a table and contains cells. A cell is strongly
 * typed, so getters and setters on invalid typed-columns fail
...
public interface IDatabaseRow {
	...
	/**
	 * Get the number of cells in the row. Is the same as number of columns in table.
	 * @return
	 */
