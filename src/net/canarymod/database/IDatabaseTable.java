 ...
 * 
 * The table has columns and rows. Each column has a name
 * and a type. Selection of rows is by row number, starting
 * at 1. Selection of cells is by row and column name.
 * 
 * @author Jos Kuijpers
 */
public interface IDatabaseTable {
	...
	/**
	 * Return an array of rows where the content of the cell in column 'column' is 'value'
	 * @param column
	 * @param value
	 * @return
	 */
	...
	/**
	 * Inserts a column with the specified name and type, next to the column specified by after.
	 *
