...
public interface IDamageSource {
    ...
    /**
     * Set a custom death message to this damage type.
     * put "%d" (without ") as placeholder for a player name.
     * This message will not be localized!
     * @param deathmessage
     */
     ...
     * @return
     */
    public String getDeathMessage(IPlayer player);
     ...
     * This may return null if damage wasn't caused by an entity!
     * @return
     */
    public IEntity getDamageDealer();
    
    /**
     * Check if this damage is unblockable (penetrates armor and can't be held off by blocking it)
     * @return
     */
