...
public interface IEnchantment {
     ...
     * @return
     */
    public IEnchantment getEnchantment(Type typle);
     ...
     * @return
     */
    public int getDamageDone(IEntityLiving entity);
    
    /**
     * Calculate the damage that will be dealt to armor with this enchantment on it
     * @param damageSource
     * @return
     */
     ...
     * @return
     */
    public boolean canStack(IEnchantment other);
