...
public enum BlockType {
  ...
  //TODO: add steps that are upside down!
    ...
    /**
     * Returns the item type that equals the given String. Null if there are no matches
     * @param type
    ...
    /**
     * Returns the first found element that has the given id or null if id wasn't found
     * @param id
     * @return ItemType | NULL
     */
    ...
    /**
     * Get a human readable name for this BlockType.
     * For instance, HugeBrownMushroom will return "Huge Brown Mushroom"
     * @return
     */
    ...
    /**
     * Get a human readable name for the given BlockType.
     * For instance, HugeBrownMushroom will return "Huge Brown Mushroom"
     * @param type
     * @return
     */
