...
public interface IInventory {
     ...
     * @return
     */
    public IItem[] getContent();
    
    /**
     * Get an item with this type from the inventory.
     * If it's not inside, return null.
     * @param type
     * @return
     */
    public IItem getItem(int type);
    
    /**
     * Get item by {@link ItemType} if it exists, returns null if inventory doesn't contain this item type
     * @param type
     * @return
     */
     ...
     * @return
     */
    public IItem getItem(int type, int amount);
     ...
     * @return
     */
    public IItem getItem(ItemType type, int amount);
    ...
    /**
     * Check if this inventory contains the requested item with the requested quantity
     * @param type
     * @param amount
     * @return
     */
    ...
    /**
     * Remove item with this ID from the inventory and return the item reference for further processing
     * @param itemId
     * @return IItem
     */
    public IItem removeItem(int itemId);
    ...
    /**
     * Set a slot in the inventory with this item. Item contains slot information.
     * @param item
     */
