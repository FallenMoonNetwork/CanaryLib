...
import net.canarymod.backbone.IBackboneGroups;

public class GroupsProvider {
    private ArrayList<Group> groups;
    private IBackboneGroups backbone;
     ...
     * @param type
     */
    public GroupsProvider(IBackbone bone, IBackbone.Type type) {
        backbone = (IBackboneGroups) bone.getBackbone(IBackbone.System.GROUPS, type);
    ...
    /**
     * Returns group files under the given name or null
     * if group not exists
     * @param name
     * @return
     */
