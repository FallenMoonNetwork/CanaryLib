...
/**
 * Manages and provides permissions. Handles permission queries.
 * This class can and should be instantiated per group and if
 * player has custom permissions set also for that player.
 * It comes with a permission cache to speed up permission lookups
 * @author Chris
 *
 */
public class PermissionProvider {
    ...
    /**
     * Add a given permission to the permissions cache. The cache is limited and will prune itself
     * if it gets too big.
     * TODO: Implement something else than a HashMap to prune more effectively?
     * @param path
     * @param value
     */
    ...
    /**
     * Execute a query for the given permission path.
     * If the query finds an asterisk permission on its way to the final node,
     * it will exit prematurely with what the asterisk permission value is
     * @param permission
