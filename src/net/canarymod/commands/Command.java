...
/**
 * Basic command class. It contains some pre-defined methods
 * for a basic evaluation of commands and a run() for implementation of different commands
 * @author Chris
 *
 */
public abstract class Command {
    ...
    /**
     * Validate the command against a given player and the specifications set with the Ctor.<br>
     * <b>ONLY OVERRIDE THIS IF YOU KNOW WHAT YOU'RE DOING THERE!</b>
     * @param player
     * @param command
     * @return
     */
    public boolean parseCommand(IPlayer player, String[] command) { // TODO #Jos @Chris: Rename to validateCommand, because that is what it does
    ...
    /**
     * Implement this. You can put your logic here and issue {@link Command#parseCommand(IPlayer, String[])} 
     * to validate the command and player permissions
     * @param player
     * @param command
     */
    public abstract void run(IPlayer player, String[] command);
}
